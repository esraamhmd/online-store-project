...
<body class="product">
    <div class="container">
        <button class="btn btn-primary mt-3 me-3" onclick="window.location.href='index.php'">Main Page</button>
    </div>
    <center>
            ...
            <main >
                <div class='card' style='width: 21rem; '>
                    ...
                    <div class='card-body'>
                        ...
                        <a href='javascript:void(0);' onclick='confirmDelete($row[id])' class='btn btn-danger'>Delete product</a> 
                        <a href='javascript:void(0);' onclick='confirmEdit($row[id])' class='btn btn-primary'>Edit product</a>
                    </div>
                </div>
            </main>
        </center>";
